...
CREATE TABLE [Saldos].[AMT_BALANCE_DETAILS](
...
TRUNCATE TABLE Saldos.AMT_BALANCE_DETAILS;
DELETE FROM Saldos.AMT_BALANCE_DETAILS;

ALTER TABLE Saldos.AMT_BALANCE_DETAILS
DROP CONSTRAINT FK_AMT_BALANCE_Credit_Card;
